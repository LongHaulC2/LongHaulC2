...
def global_scope():
    ...
    # END OF DEMO
    ui.label(
        "Note: This demo may not work as expected on nicegui.io due to load balancing across multiple servers. "
        "For accurate results, please run this example locally on your machine."
