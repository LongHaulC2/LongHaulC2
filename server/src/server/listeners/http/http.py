...
def _register_new_implant(unpacked_metadata: dict) -> bytes:
    """
    ...
    with get_mysql_session() as session:
        ...
        new_implant_uuid = implant_object.implant_uuid
...
def http_response(data_from_implant: bytes):
    """
    ...
    if implant_uuid == NULL_UUID:
        ...
        msgpack_task = _register_new_implant(unpacked_metadata)
