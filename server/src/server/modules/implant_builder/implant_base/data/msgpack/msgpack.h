...
void add_int_result(nlohmann::json& result, const std::string& key, const int value);
void add_bytes_result(nlohmann::json& result, const std::string& key, const std::string& value); //for str pass  in 
void add_bytes_result(nlohmann::json& result, const std::string& key, const std::vector<uint8_t>& value); //for vector uint8_t