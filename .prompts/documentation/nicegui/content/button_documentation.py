...
def icons() -> None:
    with ui.row():
        ...
        with ui.button():
            ...
            ui.image("https://picsum.photos/id/377/640/360").classes("rounded-full size-16 ml-4")
...
def fab() -> None:
    ...
    with ui.row().classes("size-full justify-end items-end"):  # HIDE
        ui.button(icon="home", on_click=lambda: ui.notify("home")).props("fab color=accent")
