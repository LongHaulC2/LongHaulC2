...
from client.pages.listeners import start_listener_dialogue
from client.pages.menu import setup_menu
from client.pages.payloads import start_payload_dialogue
from client.pages.syntax_sidebar import build_syntax_sidebar
    ...
    with ui.column().classes("w-full h-full gap-0"):
        ...
        with ui.row().classes("w-full bg-black/40 border-t border-white/10 p-2 gap-2 items-center"):
            ...
            ui_user_input = (
                ...
                .classes("flex-grow tech-input tech-input-mono")
                .props("dense borderless dark input-class=text-emerald-400")
                .on("keydown.enter", lambda: handle_command())
                .on("keydown.up", lambda: navigate_history("up"))
